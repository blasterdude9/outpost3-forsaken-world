...
''' <summary>Gemini Repair Vehicle — repairs friendly units and buildings in the field.</summary>
Public Class RepairVehicleGemini
    Inherits Vehicle
    ...
    Public Overrides ReadOnly Property MeshFilename() As String
        Get : Return "GeminiRepairVehicle.3ds" : End Get
    End Property
End Class
