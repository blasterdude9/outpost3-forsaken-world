...
''' <summary>Eden Repair Vehicle — repairs friendly units and buildings in the field.</summary>
Public Class RepairVehicleEden
    Inherits Vehicle
    ...
    Public Overrides ReadOnly Property MeshFilename() As String
        Get : Return "EdenRepairVehicle.3ds" : End Get
    End Property
End Class
